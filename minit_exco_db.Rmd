...
minit <- db$find('{"Siri": "4/22", "Jenis": "exco"}')
...
Disediakan Oleh: ![](Kol_Hamdan.png){width=25%}  
Kol Hamdan Bin Yaccob (B)

Diluluskan Oleh: ![](dsaa_tt.png){width=39%}  
Lt Jen Dato' Sri Abdul Aziz Bin Ibrahim (B)
