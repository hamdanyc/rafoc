...
tbl %>% 
  ...
  pack_rows(index = c("Meja Diraja"=9, "Meja Diraja (Pasangan)"=8, "Tetamu Presiden"=10, "Rombongan Diraja/ADC"=9, "Khas:CIMB"=10,
                      "MR1:Black Beret (1))/Dato' Barry Tan"=10, "MR2:WestStar/EXCO(1)"=10, "MR3:Sofian Arshad (TJP 31)"=10, "MR4:EXCO(2)"=9,
                      "MR5:NADI"=10, "MR6:TJP 18/19/20/21"=10, "MR7:Black Beret (2)/Teras Sepadu"=10, "MR8:RMA Sandhurst"=10, 
                      "MR9:RMNOA"=10, "MR10:Black Beret(3)/CIMB"=10,"MR11:AFATS"=10, "MR12:Brig Jen Dato’ Hamid (B)"=10, 
                      ...
                      "MR23:Kump Ord"=10, "MR24:TUDM"=9, "MR25:Saling Erti"=10, "MR26:KPRAMD"=10, "MR27:KKD"=10, 
                      "MR28:PERNAMA"=10, "MR29:AJK"=9, "MR30:PVATM"=10, "MR31:TJT 6"=10, "VVIP (1)"=8, "VVIP (2)"=7))
