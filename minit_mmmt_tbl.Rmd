...
tibble::tibble("Perkara"= minit$Agenda_3$Tajuk,"Perbincangan dan Keputusan"=minit$Agenda_3$Keterangan,"Tindakan"=minit$Agenda_3$Keputusan) %>%
...
tibble::tibble("Siri"="2.","Perkara"=minit$Agenda_4$Tajuk,"Perbincangan dan Keputusan"=minit$Agenda_4$Keterangan,"Tindakan"=minit$Agenda_4$Keputusan) %>%
